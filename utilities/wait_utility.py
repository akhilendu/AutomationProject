...
class Wait_utility:
    ...
    def wait_until_clickable(self, driver, element):
        WebDriverWait(driver, self.EXPLICIT_WAIT).until(EC.element_to_be_clickable(element)) #ec- expected condition, EC.element_to_be_clickable to check element is clickable
